...
gbm_model <- gbm.fit(train[,7:9],train$relevance,distribution = "gaussian",interaction.depth = 10,shrinkage=0.05,n.trees=1000)
...
write_csv(submission,"submission6.csv")
print(Sys.time()-t)